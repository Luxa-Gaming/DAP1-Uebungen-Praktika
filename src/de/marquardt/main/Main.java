...
public class Main {
    public static void main(String [] args) {
        ...
        char[] firstarray = new char[]{'s','q','e','j','d','h'};
        char[] secondarray = new char[]{'s','q','e','e','d','h'};
        ...
        System.out.println("Sortiert: " + SortierungPruefen.isSorted(unsorted, 10));
        ...
        System.out.println(GleicheWerte.contentCheck(firstarray, secondarray, 3));
